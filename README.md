...
* 漏洞库基于个语言组件的经典高危漏洞版本构建
* 支持java、golang、python、前端的SCA分析
* java项目上传jar、war包，其他项目上传zip文件分析
...
项目列表如下，支持java、go、python、前端项目的组成分析：
![QQ_1769590148870](./images/QQ_1769590148870.png)

上传项目文件进行分析，java项目上传jar或war包，其他项目上传zip压缩包：
![QQ_1769590192538](./images/QQ_1769590192538.png)

分析结果会标注项目引入的依赖存在的漏洞数，以及最高的漏洞等级，可以根据结果进行上线前的卡点：
![QQ_1769590262821](./images/QQ_1769590262821.png)

进入漏洞详情可以看到存在漏洞的依赖，以及漏洞在OSV漏洞库的编号：
![QQ_1769590380176](./images/QQ_1769590380176.png)
