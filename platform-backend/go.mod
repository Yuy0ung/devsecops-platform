...
replace github.com/nwaples/rardecode => github.com/nwaples/rardecode v1.1.0

replace github.com/projectdiscovery/nuclei/v3 => ../engines/dast-engine/scanner/nuclei-src
